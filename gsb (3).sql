...
--
-- Client: 127.0.0.1
-- Généré le : Mar 14 Mai 2013 à 15:47
...
('aaa', 'Benabar', 'Octave', 'test', 'btssio', 'Mondran', '31000', 'Toulouse', '2012-10-22');
...
CREATE TABLE IF NOT EXISTS `fichefrais` (
  ...
  `idCptResp` char(4) DEFAULT NULL,
  PRIMARY KEY (`idVisiteur`,`mois`),
  KEY `idEtat` (`idEtat`),
  KEY `fk_cpt` (`idCptResp`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `fichefrais` (`idVisiteur`, `mois`, `nbJustificatifs`, `montantValide`, `dateModif`, `idEtat`, `idCptResp`) VALUES
('b34', 5, NULL, NULL, NULL, 'CR', NULL);
...
(1, 'b34', 5, 'mcdo', '2012-01-01', '450.00');
...
ALTER TABLE `fichefrais`
  ADD CONSTRAINT `fk_cpt` FOREIGN KEY (`idCptResp`) REFERENCES `comptable` (`id`),
...
ALTER TABLE `lignefraisforfait`
  ADD CONSTRAINT `fk_aaamois` FOREIGN KEY (`idVisiteur`, `mois`) REFERENCES `fichefrais` (`idVisiteur`, `mois`),
  ADD CONSTRAINT `fk_fichefraisligne` FOREIGN KEY (`idVisiteur`) REFERENCES `fichefrais` (`idVisiteur`),
